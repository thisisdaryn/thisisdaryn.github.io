...
### 1. Install R and RStudio
  ...
  + Download R @ The R Project’s Home Page
    ...
    * Windows: [https://cran.r-project.org/bin/windows/base/R-4.2.1-win.exe](https://cran.r-project.org/bin/windows/base/R-4.2.1-win.exe)
    
    * Mac (Intel):
        [https://cran.r-project.org/bin/macosx/base/R-4.2.1.pkg](https://cran.r-project.org/bin/macosx/base/R-4.2.1.pkg)
    
    * Mac (ARM: new mac models manufactured since November 2020)
        [https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.1-arm64.pkg](https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.1-arm64.pkg)
    
    * Linux https://cloud.r-project.org/bin/linux/

  + Download RStudio Desktop from RStudio
    
    * Windows [https://download1.rstudio.org/desktop/windows/RStudio-2022.07.2-576.exe](https://download1.rstudio.org/desktop/windows/RStudio-2022.07.2-576.exe)
    
    * Mac [https://download1.rstudio.org/desktop/macos/RStudio-2022.07.2-576.dmg](https://download1.rstudio.org/desktop/macos/RStudio-2022.07.2-576.dmg)
