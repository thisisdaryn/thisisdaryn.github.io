...
### 1. Install R and RStudio
  ...
  + Download RStudio Desktop from RStudio
    ...
    * Windows [https://download1.rstudio.org/desktop/windows/RStudio-2022.02.3-492.exe](https://download1.rstudio.org/desktop/windows/RStudio-2022.02.3-492.exe)
    
    * Mac [https://download1.rstudio.org/desktop/macos/RStudio-2022.02.3-492.dmg](https://download1.rstudio.org/desktop/macos/RStudio-2022.02.3-492.dmg)
